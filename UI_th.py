...
class FivePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.lbl_mae = tk.Label(self, text="RMSE: ", bg='#fafafa',fg='#203ee6' , font=("Arial", 14))
        self.lbl_mae.place(x=2, y=130)
        self.lbl_p_error = tk.Label(self, text="MAPE: ", bg='#fafafa',fg='#203ee6' , font=("Arial", 14))
    ...
    def show_tr(self):
        ...
        self.lbl_tr_modelo.configure(text = "TR modelo: {:.4f} seg.".format(np.mean(y_pred_regressor)))
        self.lbl_mae.configure(text = "RMSE: --")
        self.lbl_p_error.configure(text = "MAPE: --")
        ...
        self.axes.scatter(x[:30]  ,y_pred_regressor[:30]  , color='#203ee6', marker="x") # modelo
        self.axes.plot(x[:30]  ,y_pred_classifier[:30]  , color='#07D99A') # modelo
        self.axes.set_title('TR y clase', fontsize=10)
        self.axes.set_xlabel('Muestra')
        self.axes.set_ylabel('TR predicho (seg.)')
        self.axes.legend(['modelo TR', 'modelo clase'])
        ...
        self.axes2.legend(['class','tr', 'energy', 'zcr', 'zcr_dir'])
